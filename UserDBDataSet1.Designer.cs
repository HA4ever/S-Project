...
namespace Measurement_System {
    ...
    public partial class UserDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserTableDataTable : global::System.Data.TypedTableBase<UserTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserTableRow AddUserTableRow(int ID, string username, string Password, string UserType) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserTableRow FindBynum(int num) {
        ...
        public partial class UserTableRow : global::System.Data.DataRow {
            ...
            public int num {
                get {
                    return ((int)(this[this.tableUserTable.numColumn]));
                }
                set {
                    this[this.tableUserTable.numColumn] = value;
                }
            }
...
namespace Measurement_System.UserDBDataSet1TableAdapters {
    ...
    public partial class UserTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `UserTable` WHERE ((`num` = ?) AND ((? = 1 AND `ID` IS NULL) OR (`ID` = ?)) AND ((? = 1 AND `username` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `UserType` IS NULL) OR (`UserType` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `UserTable` (`ID`, `username`, `Password`, `UserType`) VALUES (?, ?, " +
                "?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `UserTable` SET `ID` = ?, `username` = ?, `Password` = ?, `UserType` = ? WHERE ((`num` = ?) AND ((? = 1 AND `ID` IS NULL) OR (`ID` = ?)) AND ((? = 1 AND `username` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `UserType` IS NULL) OR (`UserType` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Measurement_System.Properties.Settings.Default.UserDBConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT num, ID, username, [Password], UserType FROM UserTable";
        ...
        public virtual int Fill(UserDBDataSet1.UserTableDataTable dataTable) {
        ...
        public virtual UserDBDataSet1.UserTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDBDataSet1.UserTableDataTable dataTable = new UserDBDataSet1.UserTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDBDataSet1.UserTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_num, global::System.Nullable<int> Original_ID, string Original_username, string Original_Password, string Original_UserType) {
        ...
        public virtual int Insert(global::System.Nullable<int> ID, string username, string Password, string UserType) {
            if ((ID.HasValue == true)) {
        ...
        public virtual int Update(global::System.Nullable<int> ID, string username, string Password, string UserType, int Original_num, global::System.Nullable<int> Original_ID, string Original_username, string Original_Password, string Original_UserType) {
            if ((ID.HasValue == true)) {
